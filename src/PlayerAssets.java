...
public class PlayerAssets {
	...
	static {
		SpriteLoader.load("kirby");
		animations = new Animation[] {	new Animation(new BufferedImage[] {SpriteLoader.getSprite(9, 9, 24, 22), SpriteLoader.getSprite(38, 9, 24, 22), SpriteLoader.getSprite(67, 9, 24, 22)}, 3),
